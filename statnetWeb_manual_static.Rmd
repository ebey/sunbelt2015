...
<li>Conditionally uniform models
  <ul>
  <li>Useful for null hypotheses
  <li>e.g. All possible graphs conditional on number of ties (see degree and geodesic distributions in **statnetWeb**)
  <li>Compare test statistics from observed network to distributions of null models
  </ul>
