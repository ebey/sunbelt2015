...
As stated in @frank1986, a graph is said to be a Markov graph if only incident dyads can be conditionally dependent. In other words, dyads are dependent only if they share a node.



See @frank1986 for more on markov graphs.  
