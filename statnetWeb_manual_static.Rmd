...
* Diagnostics: 1 week
* Model-based simulation: 2 weeks
* Review and further topics: 4 weeks
...
ADD BACK THIS IMAGE (images/samplenets_small.png)
...
<font class="tutorialex">Example: Bernoulli model</font> 
<ul><li>flomarriage ~ edges</li></ul>

<font class="tutorialex">Example: Triad formation</font>  
<ul><li>flomarriage ~ edges + triangle</li></ul>

<font class="tutorialex">Example: Nodal covariates</font>  
<ul><li>flomarriage ~ edges + nodecov("wealth")</li></ul>

<font class="tutorialex">Example: -Inf coefficients</font>  
