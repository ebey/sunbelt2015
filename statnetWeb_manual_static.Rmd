...
Those with GUI (UCINET, PNet, Pajek, Siena) vs. command line (R)
...
<li>Analytical</li>
  <ul>
  <li>"Model-based" methods used when an entire network has been observed (and can be interpretted as a single example of many possible networks)
...
<font class="lobj">Learning objectives:</font> The appropriate model depends on the type of data. What kind ERGMs represent that other models can't?
