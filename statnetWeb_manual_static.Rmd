...
Conditionally uniform models
  ...
  ![](images/brg_density.png)
  ![](images/fmh_sddeg.png)  
  <li>See these distributions as overlays on the degree and geodesic distributions in **statnetWeb**.  
...
\end{align*}$$
  ...
  <font class="ex">Example:</font> **look at notes for how to make this work**
