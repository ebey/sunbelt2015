...
<font class="ex">image here</font>
  ...
  $\theta_1$ x change in stat<sub>1</sub> + $\theta_2$ x change in stat<sub>2</sub>

  For example, if we have an `edges` coefficient $\theta_1 = -5$, a `nodematch("color")` coefficient $\theta_2 = 2$ and a `degree(0)` coefficient $\theta_3 = 1$ the log-odds of the potential tie below is $(-5*1) + (2*2) + (1*-1) = -2$.
  </ul>
