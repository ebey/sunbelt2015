...
This document is meant to serve as a guide to using statnetWeb as a teaching tool for introductory network analysis courses. We will provide templates for course outlines (both 10 and 14 week formats) and discuss the programming involved in creating statnetWeb.

Suggestions for improvements and additional functionality to statnetWeb are welcome!

## Why These Tools?

Network analysis software: UCINET, PNet, Siena... R (statnet)
...
<ul>
<li>Adjacency matrices, incidence matrices, edge lists</li>
</ul>
...
* MCMC: only for model with dyadic dependent terms
    + Approximates likelihood by....
