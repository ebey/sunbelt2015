...
<li>Analytical</li>
  <ul>
  <li>Review the various frameworks for statistical network analysis (give references), and specify the framework we will be working from.
<<<<<<< HEAD
=======
  <li>The researcher creates a model, assumes that the observed network is a the outcome of a random draw from that model. (snijders)
>>>>>>> dc6f342b3f7935070f1b15ef83ef62328ae03acd
...
=======
![](images/mesa_degreedist_small.png) ![](images/mesa_degreedist_null.png)
>>>>>>> dc6f342b3f7935070f1b15ef83ef62328ae03acd
...
<font class="lobj">14 Week Course:</font>
