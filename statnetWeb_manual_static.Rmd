...
How does statnetWeb fit a model? It depends which terms are in the model.
<ul>
<li>MLE: maximum likelihood estimation</li>
<li>MCMC: Markov chain Monte Carlo estimation
<ul>
<li>only for models with dyadic dependent terms</li>
</ul>
</ul>

<font class="ex">describe MCMC briefly</font>
Potential problems with MCMC:
<ol>
<li>bimodal distributions (getting stuck in one place)
<li>
<li>
</ol>

**statnetWeb: model output**
<ul>
